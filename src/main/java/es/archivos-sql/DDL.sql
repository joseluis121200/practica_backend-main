CREATE SCHEMA IF NOT EXISTS `practica_final_backend` DEFAULT CHARACTER SET utf8mb4;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  CONSTRAINT `fk_usuario_puesto` FOREIGN KEY (`puesto_trabajo_id`) REFERENCES `puesto_de_trabajo` (`id`)
) ENGINE=InnoDB;
